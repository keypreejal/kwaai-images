...
--
-- Table structure for table `pxl_tblkwaaiusers`
--

CREATE TABLE IF NOT EXISTS `pxl_tblkwaaiusers` (
...
--
-- Dumping data for table `pxl_tblkwaaiusers`
--

INSERT INTO `pxl_tblkwaaiusers` (`UserId`, `UserName`) VALUES
(1, 'Client'),
(2, 'Contributor');
...
INSERT INTO `pxl_tblpackage` (`PackageId`, `PackageName`, `Size`, `Price`, `Year`) VALUES
(1, 'Silver', '1 Gb', '100', '1 year'),
(2, 'Gold', '3 Gb', '250', '1 year'),
(3, 'Platinum', '5 Gb', '400', '1 year');
