                  ...
                  ?>
                      <tr class="gradeA">
                          ...
                          <td class="actiontd">
                              ...
                              <a href="<?php echo base_url(); ?>slider/editSlides/<?php echo $slide->SliderId ?>"><img src="<?php echo base_url(); ?>images/admin/edit.png"></a>
                              <a id="delpage" onclick="return confirm(\'Are You Sure To Delete This Slide?\');" href="<?php echo base_url(); ?>slider/delete/<?php echo $slide->SliderId ?>"><img src="<?php echo base_url(); ?>images/admin/close.png"></a>
                          </td>
                      </tr>
