...
<div id="wrapper" class="container">
  ...
  <section class="header_text"> <div class="row">
    ...
    <div class="span6 pull-right offer-home">
    	<p>Just starting out? Select from our <span class="pay-go">Pay-As-You-Go plans</span> <span class="big-txt pull-right">&pound; 0.54</span>,  and pay as little as: </p>
        	<p style="margin-bottom:0">Need a lot of images? Our  <span class="pay-go">Subscription plans </span> offer images<span class="big-txt pull-right">&pound; 0.20</span>  for as low as:</p>
    </div>
  </div> </section>
          ...
          <div class="span3">
            <div class="service">
              <div class="responsive"> <img src="themes/images/subscription-icon.jpg" alt="" />
                ...
                <p>Flexible image subscription plans you can tailor to your needs.</p>
                <a href="#">OnDemand for commercial use</a>
				<a href="#">OnDemand for editorial use</a>
              </div>
            </div>
          </div>
          <div class="span3">
            <div class="service">
              <div class="customize"> <img src="themes/images/signin.jpg" alt="" />
                ...
                <p>Sign up for a Corbis account to receive special offers, news, and more.</p>
                <a href="#">Reigster</a>
              </div>
            </div>
          </div>
          <div class="span3">
            <div class="service">
              <div class="support"> <img src="themes/images/search.jpg" alt="" />
                <h4>Search tips</h4>
                <p>Find the right image quickly and easily with our search tips guide.</p>
                <br>
